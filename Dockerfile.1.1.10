...
RUN chmod 777 /tmp \
    && apt-get update \
    && apt-get install -y apt-utils ack dialog openssh-server openssl vim tzdata sudo xz-utils iputils-ping supervisor time libjpeg-dev xmltoman bison \
                          ...
                          g++-multilib antlr3 gperf wget curl swig rsync ccache cmake cpio fastjar haveged help2man intltool libgmp3-dev libltdl-dev \
                          libmpc-dev libmpfr-dev libncursesw5-dev libpython3-dev libreadline-dev lrzsz mkisofs nano ninja-build pkgconf python3-pip \
                          scons squashfs-tools upx-ucl xxd \
